...
export function NextTraining() {
  return (
    <section className="mx-5">
      <Link href="/workout/upperbody" className="w-full group relative overflow-hidden rounded-2xl bg-card border border-border p-5 text-left transition-all hover:border-[#bad4e1]/30 block">
