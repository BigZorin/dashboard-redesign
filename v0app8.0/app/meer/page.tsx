      ...
      <main className="pb-40">
        ...
        <div className="px-4 mt-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 font-semibold text-sm hover:bg-red-500/15 transition-colors"
          >
